...
def MultiLayerPerceptron(cv=10):
    ...
    grid = {'model__solver': ["adam"],
               ...
               'model__alpha': [1/i for i in np.linspace(100, 1, 100)],
               'model__hidden_layer_sizes': [(100,),(100,100,100,100,100),(50,),(50,50),(30,30),(60,60),(30,20,10),(20,20),(25,15),(10,40,10),(20,20,20),(30,10), (10,10,10)]}
